...
class AmazonTest {
    ...
    private Amazon amazon22Player1 = new Amazon(new Position(2,2),1);
    private Amazon amazon22Player0 = new Amazon(new Position(2,2),0);
    @BeforeEach
    /*
                +----+----+----+----+
                |    |    | A1 |    | 0
...
*/
     void setUp(){
         ...
         board.setFigure(allPositions[2][2], ArrowFigure.ARROW_FIGURE);
    ...
    {
        assertThat(amazon22Player1.getPlayerID()).isEqualTo(PlayerID.PLAYER_ONE);
        assertThat(amazon22Player0.getPlayerID()).isEqualTo(PlayerID.PLAYER_ZERO);
    }
    @Test
    void testToString()
    {
        assertThat(amazon22Player1.toString()).isEqualTo("A1");
        assertThat(amazon22Player0.toString()).isEqualTo("A0");
    }
