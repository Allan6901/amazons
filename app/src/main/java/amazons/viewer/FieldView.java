...
public class FieldView extends Label {
    ...
    private ImageView getImageView() {
        ...
        if(board.getFigure(position) == EmptyFigure.EMPTY_FIGURE) return null;
    ...
    private Image getImage() {
        ...
        if(figure == EmptyFigure.EMPTY_FIGURE) return null;
    ...
    private String getFigureImageName(Figure figure){
        StringBuilder builder = new StringBuilder("images/");
         ...
         if (figure == EmptyFigure.EMPTY_FIGURE) throw new IllegalArgumentException("Empty figure has no image");
        if (figure == ArrowFigure.ARROW_FIGURE) return builder.append("cross.png").toString();
